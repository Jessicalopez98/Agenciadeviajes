...
addItem({
  ...
  'noincluye': '<strong><br>EL VIAJE NO INCLUYE : </strong><br>-Gastos personales y extras en los hoteles.<br>-Propinas en Tailandia: 50 USD por persona (Se paga directo en destino)<br>-Ningún servicio no especificado como incluido o especificado como opcional.<br>-Visa de Tailandia<br>-Impuestos aéreos por persona',
...
addItem({
  ...
  'incluye': '<strong>EL VIAJE INCLUYE: </strong> <br>- Boleto de avión. <br>- Boleto tren bala Tokyo - Hiroshima.  <br>- 2 noches de alojamiento en Hiroshima. <br>- 3 noches de alojamiento en Osaka. <br>- 1 noche de alojamiento en Nagoya. <br>- 03 noches de alojamiento en Tokio. <br>- Visitas indicadas. <br>- Autocar con aire acondicionado.<br>',
  'noincluye': '<strong><br>EL VIAJE NO INCLUYE:</strong> <br>- Gastos personales y extras.  <br>- Bebidas. <br>- Propinas Japón: 50 USD por persona (se pagan directamente en destino). <br>- Ningún servicio no especificado como incluido o especificado como opcional).',
...
addItem({
  ...
  'incluye': '<strong>EL VIAJE INCLUYE: </strong> <br>- Boleto de avión en viaje redondo México -Bangkok - México, en clase tusrita. <br>- Boleto de avión Chiang Mai - Phuket en clase turista. <br>- Boleto de avión Phuket - Bangkok en clase turista. <br>- 2 noches de alojamiento en Bangkpk. <br>- 1 noche de alojamiento en Phitsanuloke. <br>- 1 noche de alojamiento en Chiang Rai. <br>- 1 noche de alojamiento en Chiang Mai. <br>- 2 noches de alojamiento en Phuket. <br>- Régimen alimenticio indicado en itinerario.  <br>- Autocar con aire acondicionado.<br>',
  'noincluye': '<strong><br>El VIAJE NO INCLUYE:</strong><br>- Gastos personales y extras en hoteles, BebidasPropinas para maleteros, camaristas, meseros, etc.<br> -Propinas en Tailandia: 50 USD por persona (Se paga directo en destino)<br>-Gastos estras en los hoteles como llamadas telefónicas, lavandería, etc.<br> -Visa de Tailanda.<br>-Fee de cámaras en los monumentos.<br> -Ningún servicio no específicado como incluido o especificado como opcional, Impuestos aéreos',
...
addItem({
  ...
  'incluye': '<strong> EL VIAJE INCLUYE: </strong><br> -Vuelos. <br> -Hospedaje. <br>-Desayuno. <br> -Guía habla hispana. <br> -Traslados. <br>-Visitas.<br>',
  'noincluye': '<strong><br>EL VIAJE NO INCLUYE: </strong> <br> -Gastos personales y extras en los hoteles. <br> -Bebidas. <br> -Propinas en Turquía: 45 USD por persona. <br> -Impuestos. <br> -Tasa de servicio a bordo del crucero. <br> -Visa de Turquía.<br>',
...
addItem({
  ...
  'incluye': '<strong> EL VIAJE INCLUYE: </strong><br> -Vuelos. <br> -Hospedaje. <br>-Desayuno. <br> -Guía habla hispana. <br> -Traslados. <br>-Visitas.<br>',
  'noincluye': '<strong><br> EL VIAJE NO INCLUYE: </strong><br> -Seguro de viajero. <br> -Gastos personales y propinas a maleteros, trasladistas y meseros. <br> -Actividades acuáticas, snorkel, buceo con tanque, etc. <br> -Exceso de equipaje. <br> -Propinas.',
...
addItem({
  ...
  'incluye': '<strong> EL VIAJE INCLUYE: </strong><br> -Vuelos. <br> -Hospedaje. <br>-Desayuno. <br> -Guía habla hispana. <br> -Traslados. <br>-Visitas.<br>',
  'noincluye': '<strong><br>EL VIAJE NO INCLUYE: </strong><br> -IMPUESTOS $399 USD POR PERSONA. <br> -Traslados en los parques Disney. <br> -Tickets Universal. <br> -Alimentos, seguro de asistencia médica, propinas. <br> -Equipaje documentado y asiento asignado. ',
  'duracion': '8 días | 7 noches',
  'dias': 8,
  'noches': 7
})
...
addItem({
  ...
  'noincluye': '<strong><br>EL VIAJE NO INCLUYE : </strong><br>- Tarjeta de Asistencia Turística (seguro de viajero). Consultar opciones.<br> - Ningún servicio no especificado.<br> - Excursiones opcionales.<br> - Gastos personales y propinas a maleteros, trasladistas y meseros.',
